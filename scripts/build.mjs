...
const alternates = (code) =>
  LOCALE_CODES.map(
    (other) => `    <xhtml:link rel="alternate" hreflang="${other}" href="${SITE}${LOCALES[other].path}"/>`
  )
    .concat(`    <xhtml:link rel="alternate" hreflang="x-default" href="${SITE}${LOCALES[DEFAULT_LOCALE].path}"/>`)
    .join('\n');
